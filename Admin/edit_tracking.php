...
?>
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="form-group">
                                    <label>From</label>
                                    <input type="text" name="lon" class="form-control" value="<?php echo $data["lon"];?>" placeholder="-74.00597">
                                </div>
                                <div class="form-group">
                                    <label>To</label>
                                    <input type="text" name="lat" class="form-control" value="<?php echo $data["lat"];?>" placeholder="40.71427">
                                </div>
                                <div class="checkbox">
                                    <label>
